export default function Privacy() {
  return (
    <div style={{
      ...
      <p style={{color:'#6666aa', marginBottom:32}}>
        Last updated / Dernière mise à jour : May 16, 2026
      </p>

      {/* ENGLISH */}
      <h2 style={{color:'#aaaaff'}}>🇨🇦 English</h2>
      ...
      <h3 style={{color:'#f5a623'}}>1. Information We Collect</h3>
      ...
      <h3 style={{color:'#f5a623'}}>2. How We Use Your Information</h3>
      ...
      <h3 style={{color:'#f5a623'}}>3. Google AdSense & Cookies</h3>
      <p>We use <b>Google AdSense</b> to display advertisements on our site. Google may use cookies to serve ads based on your prior visits to our site or other sites on the internet. You can opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" style={{color:'#aaaaff'}}>Google's Ads Settings</a>.</p>
      ...
      <h3 style={{color:'#f5a623'}}>4. Payments & Subscriptions</h3>
      <p>Payments are processed securely by <b>Stripe</b>. We do not store your credit card number, CVV, or full payment details on our servers. Stripe's privacy policy is available at <a href="https://stripe.com/privacy" style={{color:'#aaaaff'}}>stripe.com/privacy</a>.</p>

      <h3 style={{color:'#f5a623'}}>5. Sharing Your Information</h3>
      ...
      <h3 style={{color:'#f5a623'}}>6. Data Retention</h3>
      ...
      <h3 style={{color:'#f5a623'}}>7. Children's Privacy</h3>
      ...
      <h3 style={{color:'#f5a623'}}>8. Your Rights</h3>
      ...
      <h3 style={{color:'#f5a623'}}>9. Quebec Privacy Law (Law 25)</h3>
      ...
      <h3 style={{color:'#f5a623'}}>10. Security</h3>
      ...
      <h3 style={{color:'#f5a623'}}>11. Changes to This Policy</h3>
      ...
      <h3 style={{color:'#f5a623'}}>12. Contact Us</h3>
      <p>Email: <a href="mailto:lucaboemio@gmail.com" style={{color:'#aaaaff'}}>lucaboemio@gmail.com</a><br/>Website: playstreakle.com</p>

      {/* DIVIDER */}
      <hr style={{border:'1px solid #2a2a4a', margin:'48px 0'}}/>

      {/* FRENCH */}
      <h2 style={{color:'#aaaaff'}}>🇫🇷 Français</h2>
      ...
      <h3 style={{color:'#f5a623'}}>1. Informations que nous collectons</h3>
      ...
      <h3 style={{color:'#f5a623'}}>2. Utilisation de vos informations</h3>
      ...
      <h3 style={{color:'#f5a623'}}>3. Google AdSense et témoins de connexion</h3>
      <p>Nous utilisons <b>Google AdSense</b> pour afficher des publicités. Google peut utiliser des cookies pour diffuser des annonces basées sur vos visites antérieures. Vous pouvez désactiver la publicité personnalisée en visitant les <a href="https://www.google.com/settings/ads" style={{color:'#aaaaff'}}>Paramètres des annonces Google</a>.</p>
      ...
      <h3 style={{color:'#f5a623'}}>4. Paiements et abonnements</h3>
      <p>Les paiements sont traités par <b>Stripe</b>. Nous ne stockons pas vos coordonnées bancaires complètes. La politique de Stripe est disponible à <a href="https://stripe.com/privacy" style={{color:'#aaaaff'}}>stripe.com/privacy</a>.</p>

      <h3 style={{color:'#f5a623'}}>5. Partage de vos informations</h3>
      ...
      <h3 style={{color:'#f5a623'}}>6. Conservation des données</h3>
      ...
      <h3 style={{color:'#f5a623'}}>7. Protection des mineurs</h3>
      ...
      <h3 style={{color:'#f5a623'}}>8. Vos droits</h3>
      ...
      <h3 style={{color:'#f5a623'}}>9. Loi 25 du Québec</h3>
      ...
      <h3 style={{color:'#f5a623'}}>10. Sécurité</h3>
      ...
      <h3 style={{color:'#f5a623'}}>11. Modifications</h3>
      ...
      <h3 style={{color:'#f5a623'}}>12. Nous contacter</h3>
      <p>Courriel : <a href="mailto:lucaboemio@gmail.com" style={{color:'#aaaaff'}}>lucaboemio@gmail.com</a><br/>Site web : playstreakle.com</p>

      <div style={{marginTop:48, paddingTop:24, borderTop:'1px solid #2a2a4a', color:'#6666aa', fontSize:13}}>
