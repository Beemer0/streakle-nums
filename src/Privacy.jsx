export default function Privacy() {
  return (
    <div style={{
      ...
      color: '#F5F0E8', minHeight: '100vh', lineHeight: 1.8,
    }}>
      ...
      <p style={{color:'#7A6E5F', marginBottom:32}}>
        Last updated / Dernière mise à jour : May 16, 2026
      </p>

      {/* ENGLISH */}
      <h2 style={{color:'#C9A84C'}}>🇨🇦 English</h2>
      ...
      <h3 style={{color:'#C9A84C'}}>1. Information We Collect</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>2. How We Use Your Information</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>3. Google AdSense & Cookies</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>4. Payments & Subscriptions</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>5. Sharing Your Information</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>6. Data Retention</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>7. Children's Privacy</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>8. Your Rights</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>9. Quebec Privacy Law (Law 25)</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>10. Security</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>11. Changes to This Policy</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>12. Contact Us</h3>
      ...
      {/* FRENCH */}
      <h2 style={{color:'#C9A84C'}}>🇫🇷 Français</h2>
      ...
      <h3 style={{color:'#C9A84C'}}>1. Informations que nous collectons</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>2. Utilisation de vos informations</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>3. Google AdSense et témoins de connexion</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>4. Paiements et abonnements</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>5. Partage de vos informations</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>6. Conservation des données</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>7. Protection des mineurs</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>8. Vos droits</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>9. Loi 25 du Québec</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>10. Sécurité</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>11. Modifications</h3>
      ...
      <h3 style={{color:'#C9A84C'}}>12. Nous contacter</h3>
