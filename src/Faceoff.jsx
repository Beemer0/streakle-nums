...
const PLAYERS = [
  // ── LEGENDS ──
  {n:"Wayne Gretzky",t:["EDM","LAK","STL","NYR"],a:["SC_CHAMP","HART","ALL_STAR","ART_ROSS","TED_LINDSAY","CONN_SMYTHE"],f:99},
  {n:"Mario Lemieux",t:["PIT"],a:["SC_CHAMP","CONN_SMYTHE","HART","ALL_STAR","ART_ROSS","TED_LINDSAY","CALDER"],f:99},
  {n:"Gordie Howe",t:["DET","HFD"],a:["HART","ALL_STAR","ART_ROSS","SC_CHAMP"],f:99},
  {n:"Bobby Orr",t:["BOS"],a:["SC_CHAMP","HART","ALL_STAR","NORRIS","ART_ROSS","CALDER","CONN_SMYTHE","TED_LINDSAY"],f:99},
  {n:"Steve Yzerman",t:["DET"],a:["SC_CHAMP","CONN_SMYTHE","ALL_STAR","SELKE","TED_LINDSAY"],f:98},
  ...
  {n:"Brett Hull",t:["CGY","STL","DAL","DET","PHX"],a:["SC_CHAMP","HART","ALL_STAR","TED_LINDSAY"],f:97},
  {n:"Joe Sakic",t:["QUE","COL"],a:["SC_CHAMP","CONN_SMYTHE","HART","ALL_STAR","TED_LINDSAY"],f:97},
  {n:"Martin Brodeur",t:["NJD","STL"],a:["SC_CHAMP","ALL_STAR","VEZINA","CALDER"],f:98},
  {n:"Nicklas Lidstrom",t:["DET"],a:["SC_CHAMP","CONN_SMYTHE","ALL_STAR","NORRIS"],f:98},
  {n:"Peter Forsberg",t:["QUE","COL","PHI","NSH"],a:["SC_CHAMP","HART","ALL_STAR","ART_ROSS","CALDER"],f:99},
  {n:"Jarome Iginla",t:["CGY","PIT","BOS","COL","LAK"],a:["ALL_STAR","ART_ROSS","TED_LINDSAY"],f:92},
  {n:"Martin St. Louis",t:["CGY","TBL","NYR"],a:["SC_CHAMP","HART","ALL_STAR","ART_ROSS","TED_LINDSAY"],f:90},
  ...
  {n:"Paul Kariya",t:["ANA","COL","NSH","STL"],a:["ALL_STAR"],f:88},
  {n:"Teemu Selanne",t:["WIN","ANA","SJS","COL"],a:["SC_CHAMP","ALL_STAR","CALDER"],f:95},
  {n:"Dominik Hasek",t:["BUF","DET","OTT","COL","CHI"],a:["SC_CHAMP","HART","ALL_STAR","VEZINA","TED_LINDSAY"],f:98},
  {n:"Eric Lindros",t:["PHI","NYR","TOR","DAL"],a:["HART","ALL_STAR","TED_LINDSAY"],f:90},
  {n:"Mike Modano",t:["MIN","DAL","DET"],a:["SC_CHAMP","ALL_STAR"],f:90},
  {n:"Mike Vernon",t:["CGY","DET","SJS","FLA"],a:["SC_CHAMP","CONN_SMYTHE"],f:72},
  ...
  {n:"Alexander Ovechkin",t:["WSH"],a:["SC_CHAMP","CONN_SMYTHE","HART","ALL_STAR","ART_ROSS","TED_LINDSAY","CALDER"],f:99},
  {n:"Evgeni Malkin",t:["PIT"],a:["SC_CHAMP","CONN_SMYTHE","HART","ALL_STAR","ART_ROSS","CALDER","TED_LINDSAY"],f:95},
  {n:"Nikita Kucherov",t:["TBL"],a:["SC_CHAMP","HART","ALL_STAR","ART_ROSS","TED_LINDSAY"],f:97},
  {n:"Nathan MacKinnon",t:["COL"],a:["SC_CHAMP","HART","ALL_STAR","TED_LINDSAY","CALDER"],f:98},
  {n:"Connor McDavid",t:["EDM"],a:["HART","ALL_STAR","ART_ROSS","TED_LINDSAY","CONN_SMYTHE"],f:99},
  {n:"Leon Draisaitl",t:["EDM"],a:["HART","ALL_STAR","ART_ROSS","TED_LINDSAY"],f:95},
  {n:"David Pastrnak",t:["BOS"],a:["ALL_STAR"],f:92},
  {n:"Auston Matthews",t:["TOR"],a:["ALL_STAR","TED_LINDSAY","CALDER","HART"],f:95},
  {n:"Mitch Marner",t:["TOR","VGK"],a:["ALL_STAR"],f:85},
  {n:"Artemi Panarin",t:["CHI","CBJ","NYR"],a:["ALL_STAR","CALDER"],f:90},
  {n:"Mark Scheifele",t:["WPG"],a:["ALL_STAR"],f:80},
  {n:"Kyle Connor",t:["WPG"],a:["ALL_STAR"],f:78},
  {n:"Patrik Laine",t:["WPG","CBJ","MTL"],a:["ALL_STAR"],f:80},
  {n:"Blake Wheeler",t:["BOS","ATL","WPG"],a:["ALL_STAR"],f:75},
  {n:"Jonathan Marchessault",t:["FLA","VGK","NSH"],a:["SC_CHAMP","CONN_SMYTHE","ALL_STAR"],f:78},
  {n:"Reilly Smith",t:["BOS","DAL","FLA","VGK","PIT","NYR"],a:["SC_CHAMP"],f:62},
  {n:"William Karlsson",t:["ANA","CBJ","VGK"],a:["SC_CHAMP","ALL_STAR"],f:68},
  {n:"Brayden McNabb",t:["BUF","LAK","VGK"],a:["SC_CHAMP"],f:45},
  {n:"Marc-Andre Fleury",t:["PIT","VGK","CHI","MIN"],a:["SC_CHAMP","ALL_STAR","VEZINA"],f:92},
  ...
  {n:"Igor Shesterkin",t:["NYR"],a:["ALL_STAR","VEZINA"],f:88},
  {n:"Frederik Andersen",t:["ANA","TOR","CAR","OTT"],a:["ALL_STAR"],f:72},
  {n:"John Gibson",t:["ANA","DET"],a:["ALL_STAR"],f:75},
  {n:"Sergei Bobrovsky",t:["PHI","CBJ","FLA"],a:["ALL_STAR","VEZINA","SC_CHAMP"],f:82},
  {n:"Jaroslav Halak",t:["MTL","STL","WSH","NYI","BOS","VAN","NYR"],a:["ALL_STAR"],f:68},
  {n:"Ben Bishop",t:["OTT","TBL","LAK","DAL"],a:["ALL_STAR"],f:70},
  {n:"Corey Crawford",t:["CHI"],a:["SC_CHAMP"],f:72},
  {n:"Jimmy Howard",t:["DET"],a:["ALL_STAR"],f:65},
  {n:"Robin Lehner",t:["OTT","BUF","NYI","CHI","VGK"],a:["ALL_STAR"],f:70},
  {n:"Semyon Varlamov",t:["WSH","COL","NYI"],a:["ALL_STAR"],f:68},

  // ── DEFENSEMEN ──
  {n:"Erik Karlsson",t:["OTT","SJS","PIT"],a:["ALL_STAR","NORRIS"],f:90},
  {n:"Drew Doughty",t:["LAK"],a:["SC_CHAMP","ALL_STAR","NORRIS"],f:90},
  ...
  {n:"John Carlson",t:["WSH"],a:["SC_CHAMP","ALL_STAR"],f:80},
  {n:"Kris Letang",t:["PIT"],a:["SC_CHAMP","ALL_STAR"],f:85},
  {n:"Alex Pietrangelo",t:["STL","VGK"],a:["SC_CHAMP","ALL_STAR"],f:85},
  {n:"Mark Giordano",t:["CGY","SEA","TOR"],a:["ALL_STAR","NORRIS"],f:78},
  {n:"Aaron Ekblad",t:["FLA"],a:["ALL_STAR","CALDER","SC_CHAMP"],f:78},
  {n:"Jonathan Toews",t:["CHI"],a:["SC_CHAMP","CONN_SMYTHE","ALL_STAR","SELKE"],f:92},
  ...
  {n:"Chris Pronger",t:["HFD","STL","EDM","ANA","PHI"],a:["SC_CHAMP","HART","ALL_STAR","NORRIS"],f:95},
  ...
  {n:"Ryan Suter",t:["NSH","MIN","DAL","STL"],a:["ALL_STAR"],f:78},
  ...
  {n:"Rasmus Dahlin",t:["BUF"],a:["ALL_STAR"],f:82},
  {n:"Dougie Hamilton",t:["BOS","CGY","CAR","NJD"],a:["ALL_STAR"],f:78},
  {n:"Devon Toews",t:["NYI","COL"],a:["SC_CHAMP","ALL_STAR"],f:72},
  {n:"Mattias Ekholm",t:["NSH","EDM"],a:["ALL_STAR"],f:68},
  {n:"Jared Spurgeon",t:["MIN"],a:["ALL_STAR"],f:65},
  {n:"Morgan Rielly",t:["TOR"],a:["ALL_STAR"],f:72},
  {n:"Justin Faulk",t:["CAR","STL"],a:["ALL_STAR"],f:68},
  {n:"Oliver Ekman-Larsson",t:["PHX","ARI","VAN","FLA","TOR"],a:["ALL_STAR","SC_CHAMP"],f:72},
  {n:"Ivan Provorov",t:["PHI","BOS","CBJ"],a:["ALL_STAR"],f:62},
  {n:"Darnell Nurse",t:["EDM"],a:["ALL_STAR"],f:65},
  {n:"Seth Jones",t:["NSH","CBJ","CHI","FLA"],a:["ALL_STAR","SC_CHAMP"],f:78},
  ...
  {n:"Luc Robitaille",t:["LAK","PIT","NYR","DET"],a:["SC_CHAMP","ALL_STAR","CALDER"],f:88},
  {n:"Pat Verbeek",t:["NJD","NYR","DAL","DET","HFD"],a:["SC_CHAMP"],f:72},
  ...
  {n:"Keith Tkachuk",t:["WIN","PHX","STL","ATL"],a:["ALL_STAR"],f:80},
  {n:"Pierre Turgeon",t:["BUF","NYI","MTL","STL","DAL","COL"],a:["ALL_STAR"],f:80},
  ...
  {n:"Doug Gilmour",t:["STL","CGY","TOR","NJD","CHI","BUF","MTL"],a:["SC_CHAMP","SELKE","ALL_STAR"],f:82},
  {n:"Mark Recchi",t:["PIT","PHI","MTL","CAR","ATL","BOS","TBL"],a:["SC_CHAMP","ALL_STAR"],f:80},
  {n:"Adam Oates",t:["DET","STL","BOS","WSH","PHI","ANA","EDM"],a:["ALL_STAR"],f:82},
  {n:"John LeClair",t:["MTL","PHI","PIT"],a:["SC_CHAMP","ALL_STAR"],f:80},
  {n:"Keith Primeau",t:["DET","HFD","CAR","PHI"],a:["ALL_STAR"],f:72},
  ...
  {n:"Lars Eller",t:["STL","MTL","WSH","COL","PIT"],a:["SC_CHAMP"],f:52},
  ...
  {n:"Jakub Vrana",t:["WSH","DET","STL"],a:["SC_CHAMP"],f:52},
  {n:"Andre Burakovsky",t:["WSH","COL","SEA","CHI"],a:["SC_CHAMP"],f:55},
  ...
  {n:"James van Riemsdyk",t:["PHI","TOR","BOS"],a:["ALL_STAR"],f:68},
  {n:"Jeff Carter",t:["PHI","CBJ","LAK","PIT"],a:["SC_CHAMP","ALL_STAR"],f:72},
  ...
  {n:"Corey Perry",t:["ANA","DAL","MTL","TBL","EDM","CHI"],a:["SC_CHAMP","HART","ALL_STAR"],f:85},
  {n:"Bobby Ryan",t:["ANA","OTT","DET"],a:["ALL_STAR"],f:68},
  {n:"Ryan Kesler",t:["VAN","ANA","PHX"],a:["SC_CHAMP","ALL_STAR","SELKE"],f:78},
  {n:"Henrik Sedin",t:["VAN"],a:["HART","ALL_STAR","ART_ROSS"],f:88},
  {n:"Daniel Sedin",t:["VAN"],a:["ALL_STAR","ART_ROSS","TED_LINDSAY"],f:85},
  {n:"Roberto Luongo",t:["NYI","FLA","VAN"],a:["ALL_STAR"],f:85},
  {n:"Ryan Callahan",t:["NYR","TBL","OTT"],a:["ALL_STAR"],f:65},
  {n:"Marian Hossa",t:["OTT","ATL","PIT","DET","CHI"],a:["SC_CHAMP","ALL_STAR"],f:88},
  ...
  {n:"Vincent Lecavalier",t:["TBL","PHI","LAK","NJD"],a:["SC_CHAMP","ALL_STAR"],f:85},
  ...
  {n:"Steven Stamkos",t:["TBL"],a:["SC_CHAMP","ALL_STAR"],f:92},
  {n:"Pat Maroon",t:["EDM","NJD","STL","TBL","MIN"],a:["SC_CHAMP"],f:48},
  {n:"Yanni Gourde",t:["TBL","SEA"],a:["SC_CHAMP"],f:52},
  {n:"Blake Coleman",t:["NJD","TBL","CGY"],a:["SC_CHAMP"],f:52},
  ...
  {n:"Patrick Marleau",t:["SJS","TOR","PIT"],a:["ALL_STAR"],f:78},
  {n:"Joe Thornton",t:["BOS","SJS","TOR","FLA"],a:["HART","ALL_STAR","ART_ROSS"],f:90},
  ...
  {n:"Dustin Brown",t:["LAK"],a:["SC_CHAMP","ALL_STAR"],f:75},
  {n:"Anze Kopitar",t:["LAK"],a:["SC_CHAMP","ALL_STAR","SELKE"],f:90},
  ...
  {n:"Rick Nash",t:["CBJ","NYR","BOS"],a:["ALL_STAR"],f:82},
  {n:"Chris Kreider",t:["NYR","ANA"],a:["ALL_STAR"],f:72},
  {n:"Derek Stepan",t:["NYR","ARI","OTT","CAR"],a:[],f:60},
  {n:"Brendan Lemieux",t:["WPG","NYR","LAK"],a:[],f:35},
  {n:"Alexis Lafreniere",t:["NYR"],a:[],f:72},
  {n:"Kaapo Kakko",t:["NYR"],a:[],f:55},
  {n:"Brady Tkachuk",t:["OTT"],a:["ALL_STAR"],f:80},
  {n:"Tim Stutzle",t:["OTT"],a:["ALL_STAR"],f:78},
  {n:"Josh Norris",t:["OTT"],a:[],f:65},
  {n:"Mark Stone",t:["OTT","VGK"],a:["SC_CHAMP","ALL_STAR"],f:82},
  ...
  {n:"John Tavares",t:["NYI","TOR"],a:["ALL_STAR"],f:90},
  {n:"Mathew Barzal",t:["NYI"],a:["ALL_STAR","CALDER"],f:82},
  ...
  {n:"Ilya Kovalchuk",t:["ATL","NJD","LAK","MTL"],a:["ALL_STAR"],f:85},
  {n:"Dany Heatley",t:["ATL","OTT","SJS","MIN","ANA"],a:["ALL_STAR"],f:80},
  {n:"Tobias Enstrom",t:["ATL","WPG"],a:["ALL_STAR"],f:55},
  {n:"Bryan Little",t:["ATL","WPG"],a:[],f:52},
  {n:"Patrik Berglund",t:["STL"],a:[],f:45},
  {n:"David Perron",t:["STL","EDM","PIT","VGK","BUF","DET","ANA","OTT"],a:["SC_CHAMP","ALL_STAR"],f:62},
  {n:"Ryan O'Reilly",t:["COL","BUF","STL","TOR","NSH"],a:["SC_CHAMP","CONN_SMYTHE","ALL_STAR","SELKE"],f:85},
  {n:"Vladimir Tarasenko",t:["STL","NYR","OTT","FLA","DET","MIN"],a:["SC_CHAMP","ALL_STAR"],f:82},
  {n:"Colton Parayko",t:["STL"],a:["SC_CHAMP","ALL_STAR"],f:65},
  {n:"Jaden Schwartz",t:["STL","SEA"],a:["SC_CHAMP","ALL_STAR"],f:62},
  {n:"Jordan Binnington",t:["STL"],a:["SC_CHAMP","ALL_STAR"],f:78},
  ...
  {n:"Mikko Rantanen",t:["COL","CAR","DAL"],a:["SC_CHAMP","ALL_STAR"],f:90},
  ...
  {n:"Patrice Bergeron",t:["BOS"],a:["SC_CHAMP","ALL_STAR","SELKE"],f:95},
  {n:"Brad Marchand",t:["BOS","FLA"],a:["SC_CHAMP","ALL_STAR"],f:90},
  {n:"Milan Lucic",t:["BOS","LAK","EDM","CGY"],a:["SC_CHAMP","ALL_STAR"],f:65},
  ...
  {n:"Tyler Seguin",t:["BOS","DAL"],a:["ALL_STAR","SC_CHAMP"],f:82},
  ...
  {n:"Elias Lindholm",t:["CAR","CGY","VAN","BOS"],a:["ALL_STAR"],f:78},
  {n:"Sebastian Aho",t:["CAR"],a:["ALL_STAR"],f:85},
  {n:"Andrei Svechnikov",t:["CAR"],a:["ALL_STAR"],f:80},
  {n:"Teuvo Teravainen",t:["CHI","CAR"],a:["ALL_STAR"],f:72},
  {n:"Jaccob Slavin",t:["CAR"],a:["ALL_STAR"],f:72},
  {n:"Petr Mrazek",t:["DET","PHI","CAR","TOR","CHI"],a:[],f:52},
  {n:"Jordan Staal",t:["PIT","CAR"],a:["SC_CHAMP"],f:75},
  ...
  {n:"Antti Raanta",t:["CHI","NYR","PHX","ARI","CAR"],a:[],f:58},
  {n:"Mikael Granlund",t:["MIN","NSH","PIT","SJS","DAL"],a:["ALL_STAR"],f:65},
  {n:"Zach Parise",t:["NJD","MIN","NYI","COL"],a:["ALL_STAR"],f:80},
  {n:"Eric Staal",t:["CAR","MIN","NYR","MTL","BUF","FLA"],a:["SC_CHAMP","ALL_STAR"],f:80},
  {n:"Jason Zucker",t:["MIN","PIT","ARI","NJD"],a:["ALL_STAR"],f:58},
  {n:"Kirill Kaprizov",t:["MIN"],a:["ALL_STAR","CALDER"],f:90},
  ...
  {n:"Filip Forsberg",t:["WSH","NSH"],a:["ALL_STAR"],f:88},
  ...
  {n:"Juuse Saros",t:["NSH"],a:["ALL_STAR"],f:80},
  {n:"Matthew Tkachuk",t:["CGY","FLA"],a:["SC_CHAMP","ALL_STAR"],f:90},
  {n:"Johnny Gaudreau",t:["CGY","CBJ"],a:["ALL_STAR"],f:85},
  {n:"Sean Monahan",t:["CGY","MTL","OTT","NJD"],a:["ALL_STAR"],f:68},
  {n:"Mikael Backlund",t:["CGY"],a:["ALL_STAR"],f:65},
  {n:"Sam Bennett",t:["CGY","FLA"],a:["SC_CHAMP","CONN_SMYTHE"],f:65},
  {n:"Rasmus Andersson",t:["CGY"],a:["ALL_STAR"],f:60},
  {n:"David Rittich",t:["CGY","TOR","NSH","LAK"],a:["ALL_STAR"],f:48},
  {n:"Spencer Knight",t:["FLA","CHI"],a:[],f:48},
  {n:"Aleksander Barkov",t:["FLA"],a:["ALL_STAR","SELKE","SC_CHAMP"],f:90},
  {n:"Jonathan Huberdeau",t:["FLA","CGY"],a:["ALL_STAR","CALDER"],f:82},
  {n:"Carter Verhaeghe",t:["TBL","FLA"],a:["SC_CHAMP"],f:65},
  {n:"Radko Gudas",t:["TBL","PHI","WSH","FLA"],a:["SC_CHAMP"],f:45},
  {n:"Connor Hellebuyck",t:["WPG"],a:["ALL_STAR","VEZINA","HART"],f:88},
  {n:"Nikolaj Ehlers",t:["WPG"],a:["ALL_STAR"],f:75},
  {n:"Pierre-Luc Dubois",t:["CBJ","WPG","LAK"],a:["ALL_STAR"],f:75},
  {n:"Nate Schmidt",t:["WSH","VGK","VAN","WPG","FLA"],a:["SC_CHAMP"],f:48},
  {n:"Dmitry Kulikov",t:["FLA","BUF","NJD","WPG","ANA","MIN","NJD"],a:[],f:40},
  {n:"Jack Roslovic",t:["WPG","CBJ","NYR"],a:[],f:45},
  {n:"Taylor Hall",t:["EDM","NJD","ARI","BUF","BOS","CHI"],a:["HART","ALL_STAR"],f:82},
  ...
  {n:"John Klingberg",t:["DAL","ANA","TOR","MIN","EDM"],a:["ALL_STAR"],f:68},
  ...
  {n:"Nick Foligno",t:["OTT","CBJ","BOS","TOR","CHI"],a:["ALL_STAR"],f:65},
  {n:"Elias Pettersson",t:["VAN"],a:["ALL_STAR","CALDER"],f:88},
  {n:"Bo Horvat",t:["VAN","NYI"],a:["ALL_STAR"],f:78},
  {n:"Brock Boeser",t:["VAN"],a:["ALL_STAR"],f:72},
  ...
  {n:"Tyler Myers",t:["BUF","WPG","VAN"],a:["CALDER"],f:58},
  ...
  {n:"Brandon Tanev",t:["WPG","PIT","SEA"],a:["SC_CHAMP"],f:42},
  ...
  {n:"Pavel Datsyuk",t:["DET"],a:["SC_CHAMP","SELKE","ALL_STAR"],f:88},
  {n:"Henrik Zetterberg",t:["DET"],a:["SC_CHAMP","CONN_SMYTHE","ALL_STAR"],f:88},
  {n:"Daniel Alfredsson",t:["OTT","DET"],a:["CALDER","ALL_STAR"],f:85},
  {n:"Bryan Trottier",t:["NYI","PIT"],a:["SC_CHAMP","CONN_SMYTHE","HART","ART_ROSS","CALDER","ALL_STAR"],f:90},
  {n:"Mike Bossy",t:["NYI"],a:["SC_CHAMP","CONN_SMYTHE","CALDER","ALL_STAR"],f:93},
  {n:"Denis Potvin",t:["NYI"],a:["SC_CHAMP","NORRIS","CALDER","ALL_STAR"],f:90},
  {n:"Billy Smith",t:["NYI"],a:["SC_CHAMP","CONN_SMYTHE","VEZINA","ALL_STAR"],f:82},
  {n:"Grant Fuhr",t:["EDM","TOR","BUF","LAK","STL","CGY"],a:["SC_CHAMP","VEZINA","ALL_STAR"],f:88},
  {n:"Tom Barrasso",t:["BUF","PIT","OTT","CAR","TOR","STL"],a:["SC_CHAMP","VEZINA","CALDER","ALL_STAR"],f:78},
  {n:"Tim Thomas",t:["BOS","FLA","DAL"],a:["SC_CHAMP","CONN_SMYTHE","VEZINA","ALL_STAR"],f:84},
  {n:"Jonathan Quick",t:["LAK","VGK","NYR"],a:["SC_CHAMP","CONN_SMYTHE","ALL_STAR"],f:85},
  {n:"Cam Ward",t:["CAR","CHI"],a:["SC_CHAMP","CONN_SMYTHE","ALL_STAR"],f:78},
  {n:"Jean-Sebastien Giguere",t:["HFD","CGY","ANA","TOR","COL"],a:["SC_CHAMP","CONN_SMYTHE","ALL_STAR"],f:76},
  {n:"Ken Dryden",t:["MTL"],a:["SC_CHAMP","CONN_SMYTHE","VEZINA","CALDER","ALL_STAR"],f:88},
  {n:"Jacques Plante",t:["MTL","NYR","STL","TOR","BOS"],a:["SC_CHAMP","HART","VEZINA","ALL_STAR"],f:86},
  {n:"Bernie Parent",t:["BOS","PHI","TOR"],a:["SC_CHAMP","CONN_SMYTHE","VEZINA","ALL_STAR"],f:80},
  {n:"Ron Hextall",t:["PHI","QUE","NYI"],a:["CONN_SMYTHE","VEZINA","ALL_STAR"],f:74},
  {n:"Guy Carbonneau",t:["MTL","STL","DAL"],a:["SC_CHAMP","SELKE"],f:72},
  {n:"John Madden",t:["NJD","CHI","MIN"],a:["SC_CHAMP","SELKE"],f:60},
  {n:"Rod Brind'Amour",t:["STL","PHI","CAR"],a:["SC_CHAMP","SELKE","ALL_STAR"],f:82},
  {n:"Kris Draper",t:["WIN","DET"],a:["SC_CHAMP","SELKE"],f:68},
  {n:"Michael Peca",t:["VAN","BUF","NYI","EDM","CBJ","TOR"],a:["SELKE"],f:62},
  {n:"Rod Langway",t:["MTL","WSH"],a:["SC_CHAMP","NORRIS","ALL_STAR"],f:72},
  {n:"Al MacInnis",t:["CGY","STL"],a:["SC_CHAMP","CONN_SMYTHE","NORRIS","ALL_STAR"],f:85},
  {n:"Sergei Zubov",t:["NYR","PIT","DAL"],a:["SC_CHAMP","ALL_STAR"],f:75},
  {n:"Brian Rafalski",t:["NJD","DET"],a:["SC_CHAMP","ALL_STAR"],f:72},
  {n:"Sergei Gonchar",t:["WSH","BOS","PIT","OTT","DAL","MTL"],a:["SC_CHAMP","ALL_STAR"],f:72},
  {n:"Randy Carlyle",t:["TOR","PIT","WIN"],a:["NORRIS","ALL_STAR"],f:62},
  {n:"Phil Housley",t:["BUF","WIN","STL","CGY","NJD","WSH","CHI","TOR"],a:["ALL_STAR"],f:74},
  {n:"Dale Hawerchuk",t:["WIN","BUF","STL","PHI"],a:["CALDER","ALL_STAR"],f:84},
  {n:"Marcel Dionne",t:["DET","LAK","NYR"],a:["ART_ROSS","TED_LINDSAY","ALL_STAR"],f:85},
  {n:"Bobby Clarke",t:["PHI"],a:["SC_CHAMP","HART","TED_LINDSAY","ALL_STAR"],f:90},
  {n:"Marcus Naslund",t:["PIT","VAN","NYR"],a:["TED_LINDSAY","ALL_STAR"],f:78},
  {n:"Pavel Bure",t:["VAN","FLA","NYR"],a:["CALDER","ALL_STAR"],f:90},
  {n:"Alexander Mogilny",t:["BUF","VAN","NJD","TOR"],a:["SC_CHAMP","ALL_STAR"],f:80},
  {n:"Todd Bertuzzi",t:["NYI","VAN","FLA","DET","ANA","CGY"],a:["ALL_STAR"],f:68},
  {n:"Igor Larionov",t:["VAN","SJS","DET","FLA","NJD"],a:["SC_CHAMP","ALL_STAR"],f:78},
  {n:"Vincent Damphousse",t:["TOR","EDM","MTL","SJS"],a:["SC_CHAMP","ALL_STAR"],f:70},
  {n:"Sandis Ozolinsh",t:["SJS","COL","CAR","FLA","ANA","NYR"],a:["SC_CHAMP","ALL_STAR"],f:65},
  {n:"Owen Nolan",t:["QUE","COL","SJS","TOR","PHX","CGY","MIN"],a:["ALL_STAR"],f:70},
  {n:"Theo Fleury",t:["CGY","COL","NYR","CHI"],a:["SC_CHAMP","ALL_STAR"],f:78},
  {n:"Jack Eichel",t:["BUF","VGK"],a:["SC_CHAMP","ALL_STAR"],f:88},
  {n:"Sam Reinhart",t:["BUF","FLA"],a:["SC_CHAMP","ALL_STAR"],f:82},
  {n:"David Savard",t:["CBJ","TBL","MTL"],a:["SC_CHAMP"],f:55},
  {n:"Troy Brouwer",t:["CHI","WSH","STL","CGY","FLA"],a:["SC_CHAMP"],f:52},
  {n:"Barret Jackman",t:["STL","NSH"],a:["CALDER"],f:52},
  {n:"Paul Stastny",t:["COL","STL","WPG","VGK","CAR"],a:[],f:70},
  {n:"Max Pacioretty",t:["MTL","VGK","CAR","WSH","TOR"],a:[],f:72},
  {n:"Chandler Stephenson",t:["WSH","VGK","SEA"],a:["SC_CHAMP"],f:52},
  {n:"Alec Martinez",t:["LAK","VGK","CHI"],a:["SC_CHAMP"],f:56},
  {n:"Dustin Byfuglien",t:["CHI","ATL","WPG"],a:["SC_CHAMP","ALL_STAR"],f:75},
  {n:"Pat LaFontaine",t:["NYI","BUF","NYR"],a:["ALL_STAR"],f:82},
    ...
    <main style={{minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',paddingTop:0,paddingBottom:40,color:'#F5F0E8',position:'relative',overflow:'hidden'}}>
      ...
      <div style={{display:'flex',alignItems:'center',gap:12,marginBottom:2}}>
        <div style={{display:'flex',flexDirection:'column',alignItems:'center'}}>
          <h1 style={{fontSize:30,fontWeight:900,letterSpacing:2,color:'#fff',margin:0}}>FACEOFF</h1>
