...
const FIGHTERS = [
  // Heavyweights
  {n:"Jon Jones",p:["UFC"],w:["LHW","HW"],a:["CHAMPION","TITLE_DEF","KO_WIN"],f:99},
  {n:"Stipe Miocic",p:["UFC"],w:["HW"],a:["CHAMPION","TITLE_DEF","KO_WIN"],f:88},
  {n:"Daniel Cormier",p:["UFC","STRIKEFORCE"],w:["HW","LHW"],a:["CHAMPION","MULTI_CHAMP","TITLE_DEF","KO_WIN","SUB_WIN","HOF"],f:92},
  {n:"Fedor Emelianenko",p:["PRIDE","STRIKEFORCE","BELLATOR"],w:["HW"],a:["KO_WIN","SUB_WIN","CHAMPION"],f:95},
  {n:"Cain Velasquez",p:["UFC"],w:["HW"],a:["CHAMPION","KO_WIN"],f:82},
  {n:"Junior dos Santos",p:["UFC"],w:["HW"],a:["CHAMPION","KO_WIN"],f:78},
  {n:"Francis Ngannou",p:["UFC"],w:["HW"],a:["CHAMPION","KO_WIN"],f:82},
  {n:"Alistair Overeem",p:["UFC","PRIDE","STRIKEFORCE"],w:["HW","LHW"],a:["KO_WIN","CHAMPION"],f:80},
  {n:"Mirko Cro Cop",p:["PRIDE","UFC"],w:["HW"],a:["KO_WIN"],f:88},
  {n:"Mark Hunt",p:["UFC","PRIDE"],w:["HW"],a:["KO_WIN"],f:72},
  {n:"Ryan Bader",p:["UFC","BELLATOR"],w:["LHW","HW"],a:["CHAMPION","KO_WIN","MULTI_CHAMP"],f:68},
  ...
  {n:"Randy Couture",p:["UFC"],w:["HW","LHW"],a:["CHAMPION","MULTI_CHAMP","TITLE_DEF","HOF","KO_WIN"],f:90},
  {n:"Bas Rutten",p:["UFC"],w:["HW"],a:["CHAMPION","KO_WIN","SUB_WIN"],f:72},
  {n:"Cheick Kongo",p:["UFC","BELLATOR"],w:["HW"],a:["KO_WIN"],f:45},
  {n:"Sergei Pavlovich",p:["UFC"],w:["HW"],a:["KO_WIN"],f:60},
  {n:"Vitor Belfort",p:["UFC","PRIDE"],w:["MW","LHW","HW"],a:["CHAMPION","KO_WIN"],f:80},
  // Light Heavyweights
  ...
  {n:"Quinton Jackson",p:["PRIDE","UFC"],w:["LHW"],a:["CHAMPION","KO_WIN"],f:85},
  ...
  {n:"Dan Henderson",p:["UFC","PRIDE","STRIKEFORCE","BELLATOR"],w:["LHW","MW"],a:["CHAMPION","KO_WIN","HOF","MULTI_CHAMP"],f:82},
  {n:"Gegard Mousasi",p:["UFC","BELLATOR","STRIKEFORCE"],w:["LHW","MW"],a:["CHAMPION","KO_WIN","SUB_WIN"],f:72},
  {n:"Brian Stann",p:["UFC","WEC"],w:["LHW","MW"],a:["KO_WIN","CHAMPION"],f:48},
  {n:"Alex Pereira",p:["UFC"],w:["MW","LHW"],a:["CHAMPION","MULTI_CHAMP","TITLE_DEF","KO_WIN"],f:82},
  {n:"Anthony Johnson",p:["UFC","BELLATOR"],w:["WW","LHW","MW"],a:["KO_WIN"],f:68},
  {n:"Ken Shamrock",p:["UFC","PRIDE"],w:["LHW","HW"],a:["CHAMPION","HOF"],f:72},
  // Middleweights
  ...
  {n:"Chris Weidman",p:["UFC"],w:["MW"],a:["CHAMPION","KO_WIN","SUB_WIN","TITLE_DEF"],f:72},
  ...
  {n:"Rich Franklin",p:["UFC","ONE"],w:["MW"],a:["CHAMPION","KO_WIN"],f:72},
  ...
  {n:"Robbie Lawler",p:["UFC","STRIKEFORCE","BELLATOR"],w:["WW","MW"],a:["CHAMPION","KO_WIN","HOF"],f:80},
  ...
  {n:"Leon Edwards",p:["UFC"],w:["WW"],a:["CHAMPION","KO_WIN"],f:75},
  {n:"Colby Covington",p:["UFC"],w:["WW"],a:["KO_WIN"],f:65},
  {n:"Jorge Masvidal",p:["UFC","STRIKEFORCE"],w:["WW","LW"],a:["KO_WIN"],f:72},
  {n:"Nick Diaz",p:["UFC","PRIDE","STRIKEFORCE"],w:["WW","LW"],a:["CHAMPION","KO_WIN","SUB_WIN"],f:78},
  ...
  {n:"Belal Muhammad",p:["UFC"],w:["WW"],a:["CHAMPION"],f:62},
  {n:"Douglas Lima",p:["BELLATOR"],w:["WW"],a:["CHAMPION","TITLE_DEF","KO_WIN","SUB_WIN"],f:62},
  {n:"Ben Askren",p:["UFC","ONE","BELLATOR"],w:["WW"],a:["CHAMPION","SUB_WIN","TITLE_DEF"],f:65},
  ...
  {n:"Conor McGregor",p:["UFC"],w:["FW","LW"],a:["CHAMPION","MULTI_CHAMP","KO_WIN"],f:99},
  {n:"BJ Penn",p:["UFC"],w:["WW","LW"],a:["CHAMPION","MULTI_CHAMP","SUB_WIN","HOF"],f:92},
  {n:"Charles Oliveira",p:["UFC"],w:["LW","FW"],a:["CHAMPION","SUB_WIN","KO_WIN"],f:82},
  ...
  {n:"Dustin Poirier",p:["UFC"],w:["LW","FW"],a:["KO_WIN","SUB_WIN"],f:80},
  {n:"Tony Ferguson",p:["UFC"],w:["LW"],a:["KO_WIN","SUB_WIN"],f:72},
  {n:"Justin Gaethje",p:["UFC"],w:["LW"],a:["KO_WIN"],f:72},
  {n:"Nate Diaz",p:["UFC","WEC"],w:["WW","LW"],a:["SUB_WIN","KO_WIN"],f:78},
  {n:"Frankie Edgar",p:["UFC"],w:["LW","FW","BW"],a:["CHAMPION"],f:78},
  {n:"Benson Henderson",p:["UFC","WEC","BELLATOR"],w:["LW","FW"],a:["CHAMPION","TITLE_DEF","SUB_WIN","KO_WIN"],f:72},
  {n:"Gilbert Melendez",p:["UFC","STRIKEFORCE"],w:["LW"],a:["CHAMPION","TITLE_DEF"],f:62},
  {n:"Patricio Pitbull",p:["BELLATOR"],w:["FW","LW"],a:["CHAMPION","TITLE_DEF","KO_WIN","MULTI_CHAMP"],f:65},
  ...
  {n:"Ilia Topuria",p:["UFC"],w:["FW","LW"],a:["CHAMPION","KO_WIN","MULTI_CHAMP"],f:72},
  ...
  {n:"Urijah Faber",p:["UFC","WEC"],w:["BW","FW"],a:["HOF","SUB_WIN","KO_WIN","CHAMPION","TITLE_DEF"],f:78},
  // Bantamweights
  {n:"Dominick Cruz",p:["UFC","WEC"],w:["BW"],a:["CHAMPION","TITLE_DEF"],f:80},
  ...
  {n:"Merab Dvalishvili",p:["UFC"],w:["BW"],a:["CHAMPION","SUB_WIN","TITLE_DEF"],f:62},
  {n:"Bibiano Fernandes",p:["ONE"],w:["BW"],a:["CHAMPION","TITLE_DEF","SUB_WIN"],f:65},
  {n:"Joseph Benavidez",p:["UFC","WEC"],w:["FLY","BW"],a:["KO_WIN","SUB_WIN"],f:55},
  // Flyweights
  {n:"Demetrious Johnson",p:["UFC","WEC","ONE"],w:["FLY","BW"],a:["CHAMPION","TITLE_DEF","SUB_WIN","KO_WIN"],f:90},
  {n:"Brandon Moreno",p:["UFC"],w:["FLY"],a:["CHAMPION","TITLE_DEF","SUB_WIN","KO_WIN"],f:72},
  {n:"Deiveson Figueiredo",p:["UFC"],w:["FLY","BW"],a:["CHAMPION","TITLE_DEF","KO_WIN","SUB_WIN"],f:68},
  {n:"Adriano Moraes",p:["ONE"],w:["FLY"],a:["CHAMPION","TITLE_DEF","SUB_WIN","KO_WIN"],f:55},
  {n:"Alexandre Pantoja",p:["UFC"],w:["FLY"],a:["CHAMPION","TITLE_DEF","SUB_WIN","KO_WIN"],f:60},
  ...
  {n:"Holly Holm",p:["UFC"],w:["WBW","WFW"],a:["CHAMPION","KO_WIN"],f:72},
  ...
  {n:"Alexa Grasso",p:["UFC"],w:["WFly","WSW"],a:["CHAMPION","SUB_WIN"],f:62},
  // Women's Strawweight
  {n:"Rose Namajunas",p:["UFC"],w:["WSW"],a:["CHAMPION","KO_WIN","SUB_WIN"],f:72},
  {n:"Zhang Weili",p:["UFC"],w:["WSW"],a:["CHAMPION","TITLE_DEF","KO_WIN","SUB_WIN"],f:72},
  ...
  {n:"Tatiana Suarez",p:["UFC"],w:["WSW"],a:["SUB_WIN"],f:52},
  // ── Additional Heavyweights ──
  {n:"Antonio Rodrigo Nogueira",p:["PRIDE","UFC"],w:["HW"],a:["CHAMPION","TITLE_DEF","SUB_WIN","KO_WIN","HOF"],f:88},
  {n:"Andrei Arlovski",p:["UFC","STRIKEFORCE"],w:["HW"],a:["CHAMPION","KO_WIN"],f:75},
  {n:"Brock Lesnar",p:["UFC"],w:["HW"],a:["CHAMPION","KO_WIN"],f:82},
  {n:"Frank Mir",p:["UFC"],w:["HW"],a:["CHAMPION","SUB_WIN"],f:72},
  ...
  {n:"Pedro Rizzo",p:["UFC"],w:["HW"],a:["KO_WIN"],f:58},
  ...
  {n:"Chael Sonnen",p:["UFC","STRIKEFORCE","BELLATOR"],w:["MW","LHW"],a:["SUB_WIN"],f:80},
  ...
  {n:"Rory MacDonald",p:["UFC","BELLATOR"],w:["WW"],a:["CHAMPION","KO_WIN"],f:68},
  {n:"Jake Shields",p:["UFC","STRIKEFORCE","BELLATOR","PRIDE"],w:["WW","MW"],a:["CHAMPION","SUB_WIN"],f:65},
  {n:"Diego Sanchez",p:["UFC"],w:["WW","LW"],a:["KO_WIN","SUB_WIN"],f:68},
  {n:"Paul Daley",p:["UFC","STRIKEFORCE","BELLATOR"],w:["WW"],a:["KO_WIN"],f:60},
  {n:"Lorenz Larkin",p:["UFC","BELLATOR","STRIKEFORCE"],w:["WW","MW"],a:["KO_WIN"],f:52},
  {n:"Edson Barboza",p:["UFC"],w:["LW","WW"],a:["KO_WIN"],f:65},
  {n:"Kevin Holland",p:["UFC"],w:["WW","MW"],a:["KO_WIN","SUB_WIN"],f:58},
  ...
  {n:"Dan Hooker",p:["UFC"],w:["LW","FW"],a:["KO_WIN","SUB_WIN"],f:60},
  {n:"Paul Felder",p:["UFC"],w:["LW"],a:["KO_WIN","SUB_WIN"],f:52},
  {n:"Kevin Lee",p:["UFC"],w:["LW","WW"],a:["SUB_WIN","KO_WIN"],f:55},
  ...
  {n:"Marlon Moraes",p:["UFC"],w:["BW"],a:["KO_WIN","SUB_WIN"],f:60},
  ...
  {n:"Tim Elliott",p:["UFC"],w:["FLY"],a:["SUB_WIN","KO_WIN"],f:45},
  {n:"Sergio Pettis",p:["UFC","BELLATOR"],w:["FLY","BW"],a:["CHAMPION","KO_WIN","SUB_WIN"],f:52},
  {n:"Kai Kara-France",p:["UFC"],w:["FLY"],a:["KO_WIN"],f:55},
  {n:"Manel Kape",p:["UFC"],w:["FLY","FW"],a:["KO_WIN","SUB_WIN"],f:48},
  {n:"Matheus Nicolau",p:["UFC"],w:["FLY"],a:["SUB_WIN"],f:45},
  ...
  {n:"Liz Carmouche",p:["UFC","BELLATOR"],w:["WBW"],a:["SUB_WIN","KO_WIN","CHAMPION"],f:55},
  {n:"Jessica Eye",p:["UFC"],w:["WBW","WFly"],a:["KO_WIN"],f:50},
  {n:"Aspen Ladd",p:["UFC"],w:["WBW"],a:["KO_WIN","SUB_WIN"],f:48},
  ...
  {n:"Paige VanZant",p:["UFC"],w:["WSW"],a:["KO_WIN","SUB_WIN"],f:58},
  ...
  {n:"Christian Lee",p:["ONE"],w:["LW","WW"],a:["CHAMPION","TITLE_DEF","SUB_WIN","KO_WIN","MULTI_CHAMP"],f:58},
  {n:"Stamp Fairtex",p:["ONE"],w:["WSW","WFly","WFW"],a:["CHAMPION","KO_WIN","SUB_WIN"],f:55},
  {n:"Ok Rae Yoon",p:["ONE"],w:["LW"],a:["CHAMPION","KO_WIN"],f:50},
  {n:"Thanh Le",p:["ONE"],w:["FW"],a:["CHAMPION","KO_WIN"],f:52},
  // ── AUDIT ADDITIONS (2026-06) ──
  {n:"Anthony Pettis",p:["UFC","WEC"],w:["LW","FW","WW"],a:["CHAMPION","KO_WIN","SUB_WIN"],f:75},
  {n:"Josh Barnett",p:["UFC","PRIDE","STRIKEFORCE"],w:["HW"],a:["CHAMPION","SUB_WIN","KO_WIN"],f:70},
  {n:"Mark Coleman",p:["UFC","PRIDE"],w:["HW"],a:["CHAMPION","KO_WIN","HOF"],f:72},
  {n:"Don Frye",p:["UFC","PRIDE"],w:["HW"],a:["CHAMPION","KO_WIN","SUB_WIN","HOF"],f:65},
  {n:"Pat Miletich",p:["UFC"],w:["WW"],a:["CHAMPION","TITLE_DEF","HOF"],f:60},
  {n:"Sean Sherk",p:["UFC"],w:["WW","LW"],a:["CHAMPION","SUB_WIN"],f:58},
  {n:"Jens Pulver",p:["UFC","WEC","PRIDE"],w:["LW","FW"],a:["CHAMPION","KO_WIN"],f:62},
  {n:"Kyoji Horiguchi",p:["UFC","BELLATOR"],w:["FLY","BW"],a:["CHAMPION","KO_WIN"],f:60},
  {n:"A.J. McKee",p:["BELLATOR"],w:["FW","LW"],a:["CHAMPION","SUB_WIN","KO_WIN"],f:55},
  {n:"Michael Page",p:["BELLATOR","UFC"],w:["WW","MW"],a:["KO_WIN"],f:62},
  {n:"Gina Carano",p:["STRIKEFORCE"],w:["WFW"],a:["KO_WIN"],f:70},
  {n:"Sarah Kaufman",p:["STRIKEFORCE","UFC"],w:["WBW"],a:["CHAMPION","KO_WIN"],f:48},
];
        ...
        <div style={{marginTop:16,width:'100%',maxWidth:340,padding:'0 12px',boxSizing:'border-box',animation:'slideUp 0.3s ease'}}>
          ...
          {suggestions.length > 0 && (
            <div style={{background:'#1C1A16',border:'1px solid #2C2820',borderRadius:8,marginTop:4,overflow:'hidden'}}>
              {suggestions.map((f,i)=>(
                <div key={i} {...clickableProps(()=>handleSelect(f))} style={{
